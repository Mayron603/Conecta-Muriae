...
<head>
    ...
    <title>Área da Empresa - Muriaé Empregos</title>
    ...
    <link rel="stylesheet" href="<?= baseUrl() ?>assets/css/empresa_sidebar.css">
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light sticky-top bg-primary">
        <div class="container">
            <a class="navbar-brand" href="<?= baseUrl() ?>">
                <img src="<?= baseUrl() ?>assets/img/logo.png" alt="Muriaé Empregos" style="height: 40px;">
            </a>
                ...
                <div class="ms-lg-3 mt-3 mt-lg-0">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="<?= baseUrl() ?>empresa/configuracoes"><i class="fas fa-building me-2"></i> Perfil da Empresa</a></li>
                            <li><a class="dropdown-item" href="<?= baseUrl() ?>empresa/configuracoes"><i class="fas fa-cog me-2"></i> Configurações</a></li>
